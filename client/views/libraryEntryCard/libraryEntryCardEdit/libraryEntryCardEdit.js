Template.libraryEntryCardEdit.watchStatuses = [
	"Watching",
	"Completed",
	"Plan to watch",
	"On hold",
...
Template.libraryEntryCardEdit.rendered = function() {
	$('.entry-rating').rateit({
		max: 10,
		step: 1
	});
...
Template.libraryEntryCardEdit.entryPrivacyClass = function(privacy) {
...
Template.libraryEntryCardEdit.entryRewatchingClass = function(rewatching) {
	if (rewatching === true) {
		return "fa-history";
	} else {
		return "fa-clock-o";
...
Template.libraryEntryCardEdit.entryHighPriorityClass = function(highPriority) {
...
Template.libraryEntryCardEdit.privacyToolText = function(privacy) {
...
Template.libraryEntryCardEdit.rewatchingToolText = function(rewatching) {
...
Template.libraryEntryCardEdit.highPriorityToolText = function(highPriority) {
	if (highPriority === true) {
