Meteor.methods({
	...
	requestInviteEmail: function(email, code) {
		...
		message += "<div>Paste this code into the code field on the <a href='http://alpha.phanime.com/sign-up'>sign-up</a> page to create an account and get full access to Phanime's closed beta!</div>";
		message += "<br><br>";
